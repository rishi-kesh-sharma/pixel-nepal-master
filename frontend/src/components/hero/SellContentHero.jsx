  ...
  const datasell1 = [
    {
      ...
      icon: <AiOutlineEdit className="text-black md:text-white" size={25} />,
      color: "md:bg-red-300",
    },
    {
      id: 2,
      ...
      icon: <BsCloudUpload className="text-black md:text-white" size={20} />,
      color: "md:bg-blue-300",
    },
    {
      id: 3,
      title: "Make money",
      desc: "per every download your resources get. As simple as that.",
      icon: <CiBadgeDollar className="text-black md:text-white" size={30} />,
      color: "md:bg-orange-300",
    },
  ];
  return (
    <>
      <div className="flex items-center flex-col md:flex-row justify-between my-container dm:mt-8 w-full gap-4">
        <div className="left lg:w-1/2  mt-8">
          <TitleHeading
            title1="Sell photos, vectors & PSD"
            title2="designs on SnapHub"
          />
          <p className="text-lg mt-3 mb-8">
            Become a SnapHub contributor and make money selling your images and
            designs online.
          </p>
          {datasell1.map((item) => (
            <div className="box flex gap-3 items-center mb-5" key={item.id}>
              <div
                className={`icon flex items-center justify-center text-white ${item.color} w-12 h-12 rounded-lg`}>
                {item.icon}
              </div>
          ...
          <button className="primary-btn px-8 text-md rounded-md mt-5 w-full mx-auto md:w-auto">
...
export const SellContentHero2 = () => {
  ...
  return (
    <>
      <div className="creative py-4 md:py-12 bg-red-50 mt-8">
        <div className="my-container">
          <div className="heading text-center lg:w-1/2 m-auto">
            <TitleHeading
              title1="Enjoy creative freedom"
              className={"text-start"}
            />
            <p className="mt-2 text-start">
              At SnapHub, there’s room for your creativity, whatever your talent
              is. Choose the graphic resources you want to sell and upload them
              to our platform.
            </p>
          </div>
          <div className="content pt-4  md:pt-8 md:[&>*:nth-child(even)]:flex-row-reverse">
            {sellCdata.map((item) => (
              <div
                className="box flex flex-col md:flex-row justify-between items-center gap-5 mb-5"
                key={item.id}>
                <div className="left md:w-1/3" data-aos="fade-down">
                  <TitleHeading title1={item.title} />
                  <p className="text-sm py-3 md:py-8">{item.desc}</p>
                  <button className="primary-outline-btn rounded-md">
                    {item.category} guidelines
                  </button>
                </div>
                <div
                  className="right md:w-2/3"
                  data-aos="fade-up"
...
export const SellContentHero3 = () => {
  ...
  return (
    <>
      <div className="creative py-6 md:py-12">
        <div className="my-container">
          <div className="heading text-center md:w-1/2 m-auto">
            <TitleHeading
              title1="Why become a Pixel Nepal contributor?"
              className={"text-start"}
            />
          </div>
          <div className="content grid md:grid-cols-2 lg:grid-cols-3 gap-6 py-8">
            {data.map((item) => (
              <div
                className="box p-5 rounded-md bg-white shadow-shadow1"
                key={item.id}>
          ...
          <div className="flex items-center justify-center">
            <button className="primary-btn px-8 text-md rounded-md mt-5 ">
              Become a Contributor
            </button>
          </div>
        </div>
          ...
          {data.map((item) => (
            <Accordion
              ...
              <AccordionHeader
                ...
                className="border-b-0 transition-colors font-semibold text-lg">
                {item.title}
              </AccordionHeader>
...
export const SellContentHero5 = () => {
  return (
    <>
      <section className="my-container mt-3 md:mt-8">
        <div className="text-center">
          <TitleHeading
            title1="Intuitive tool designed to fit you"
            className={"text-start"}
          />
          <p className="text-lg mt-3 mb-8 text-start">
            Manage your photos, vectors, and PSD files easily from one single
            place.
          </p>
        </div>
        <div className="grid grid-cols-3 gap-4 mt-4 md:mt-12 justify-center ">
          <div className="box flex justify-center items-center flex-col gap-5">
            <Card1
              icon={
                <AiOutlineUpload
                  size={25}
                  className="text-primary bg-red-100"
                />
              }
            />
...
export const SellContentHero6 = () => {
  return (
    <>
      <section className="flex flex-col md:flex-row justify-between bg-orange-50 my-8 md:my-16 my-container rounded-md">
        <div className="w-full md:w-1/2">
          <img
            className="md:h-full md:w-full object-cover"
            src="https://static-contributor-fp.cdnpk.net/assets/ef78bdafd5189eaeca62.webp"
            alt=""
          />
        </div>
        <div className="md:w-1/2 py-4 md:p-12">
          <Typography variant="h5">Measure your impact</Typography>
          <Typography variant="small" className="my-6">
            From the contributor panel, you can track the status of your
            resources, monitor the downloads that your stock images & designs
            get, and check your earnings.{" "}
          </Typography>
          <Typography className="my-6">
            <span className="text-sm font-semibold">Performance history:</span>{" "}
            Get an overview of how your resources are performing on Freepik.
            Check the downloads, earnings, and statistics to make the most of
            your profile.
          </Typography>
          <Typography>
            ...
            Keep track of the status of your resources. If any of your PSD
            resources, designs, or photos are rejected, you’ll also receive
            detailed feedback on how to optimize them.
          </Typography>
          <Typography className="mt-6">
            <span className="text-sm font-semibold">CVS file: </span> Download
      ...
      <section>
        <Card
          shadow={false}
          className="relative grid h-[20rem] my-container items-end justify-center overflow-hidden text-center">
          <CardHeader
            floated={false}
            shadow={false}
            color="transparent"
            className="absolute inset-0 m-0 h-full w-full rounded-none bg-[url('https://mediablog.cdnpk.net/sites/7/2023/07/cover-EN-9.png')] bg-cover bg-center">
          ...
          <CardBody className="relative">
            <Typography
              variant="h2"
              color="white"
              className="-mt-40 font-medium leading-[1.5]">
...
export const SellContentHero7 = () => {
  return (
    <>
      <section className="my-container my-8">
        <div className="text-center">
          <TitleHeading
            title1="Discover the benefits of our community"
            className={"text-start"}
          />
          <p className="text-lg my-3 md:mb-8 text-start">
            SanpHub's contributor community is formed by thousands of
            photographers and designers from all over the world. Connect with
            other talented people and enjoy the benefits of our community.
          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-5 mt-6 md:mt-12">
          <SellContentHeroCards
            cover="https://static-contributor-fp.cdnpk.net/assets/66c4fcfcd82177608714.webp"
            title="Referral Program"
            desc="Participate in our Referral Program: tell your friends about us and make more money."
            show={true}
          />
          <SellContentHeroCards
            cover="https://static-contributor-fp.cdnpk.net/assets/ed40e953443b575b65ea.webp"
            title="Become a Brand Ambassador"
            desc="Spread the word about Freepik’s contributor program in your community and enjoy awesome perks."
            show={true}
          />
        </div>
      </section>
  ...
  return (
    <>
      <section className="my-container my-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-8 mt-12">
          <SellContentHeroCards
            cover="https://static-contributor-fp.cdnpk.net/assets/3347e90bc530283272c2.webp"
            title="Freepik PROfiles: The Freelancer Life With Illustrator Alexander Gusev"
            show={false}
            category="FEATURED ARTIST"
            author={true}
          />
          <SellContentHeroCards
            cover="https://static-contributor-fp.cdnpk.net/assets/0e6d95f9792b8ca29826.webp"
            title="Freepik PROfiles: How Prakasit Became the First Brand Ambassador"
            show={false}
            category="FEATURED ARTIST"
            author={true}
          />
          <SellContentHeroCards
            cover="https://static-contributor-fp.cdnpk.net/assets/0aebbe2d3333c9eb74e0.webp"
            title="Freepik PROfiles: The Freelancer Life With Illustrator Alexander Gusev"
            show={false}
            category="FEATURED ARTIST"
            author={true}
          />
          <SellContentHeroCards
            cover="https://static-contributor-fp.cdnpk.net/assets/4e02428d3807631c0c34.webp"
            title="Freepik PROfiles: The Freelancer Life With Illustrator Alexander Gusev"
            show={false}
            category="FEATURED ARTIST"
            author={true}
    ...
    <Card className="overflow-hidden">
      ...
      <CardBody>
        ...
        {props?.show && (
          <Link
            href="/"
            className="flex items-center font-semibold text-indigo-500 gap-2">
