      ...
      <section className="py-6 md:py-12">
        <div className="my-container m-auto">
          <h2 className="text-2xl text-center font-semibold">
            <span className="text-primary leading-loose	">Explore</span> trending
            categories on SnapHub
          </h2>
          <p className="text-center text-sm">
            Check what’s popular on SnapHub and make your project look trendy
            and professional.
          </p>
          <div>
            <div className="grid md:grid-cols-2 gap-5 mt-12 ">
              <div>
                <Card
                  ...
                  styles="md:h-[480px] rounded-lg md:rounded-tl-xl"
                />
              </div>
              <div className="grid md:grid-cols-2 gap-5">
                <Card
                  ...
                  styles=" rounded-lg lg:rounded-tr-xl"
                />
                <Card
                  title="Title One"
            ...
            <div className="grid lg:grid-cols-4 gap-5">
              <Card
                title="Title One"
                image="images/b5.avif"
                styles="h-[225px] rounded-lg lg:rounded-bl-xl"
              />
              <Card
                styles="h-[225px] rounded-lg lg:rounded-bl-xl"
                title="Title One"
  ...
  return (
    <section className="pb-12">
      <div className="my-container m-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-16 mt-12">
          <Card
            title="Title One"
            image="images/e1.avif"
            styles="h-96 rounded-xl"
            show={true}
          />
          <Card
            title="Title One"
...
export const Explore2 = () => {
  return (
    <section className="pb-12 md:pt-5">
      <div className="my-container m-auto">
        <h2 className="text-2xl text-center font-semibold md:leading-loose">
          The smartest choice for{" "}
          <span className="text-primary">creatives like you</span>
        </h2>
        <p className="text-sm text-center">
          Whether you’re looking for designs or photographs, you’ll find the
          perfect asset on Pixel Nepal.
        </p>
        <div className="grid md:grid-cols-2 gap-5">
          <div className="left mt-8 md:mt-10 lg:mt-24 flex flex-col gap-8">
            <Card1
  ...
  return (
    <>
      <section className="explore3 flex justify-center items-center flex-col">
        <div className="m-auto container   text-white flex items-center justify-center">
          <div className="left">
            <h3 className="text-lg font-medium">
              Welcome to the new{" "}
              <span className="text-orange-500">SnapHub calendar</span>
            </h3>
            <h2 className="text-2xl font-medium mt-5 mb-8 pl-3">
...
export const Explore4 = () => {
  return (
    <>
      <section className="explore4 mt-4 md:mt-12 md:h-[40vh]">
        <div className="my-container m-auto p-4 md:px-32 bg-primary/5 rounded-xl flex items-center justify-between">
          <div className="left">
    ...
    <div className="card text-center relative">
      <div className={`${styles} w-full object-cover`}>
        <img
          src={image}
          alt="title"
          className={`${styles} w-full object-cover min-h-[225px]`}
        />
      </div>
      <h2 className="capitalize mt-5 text-white absolute bottom-0 m-5">
        {title}
      </h2>
      {show && (
        <div
          className={`${styles} overlay absolute top-0 w-full bg-gray-400 rotate-6 -z-10`}></div>
      )}
    </div>
  );
};
export const Card1 = ({ title, icon, desc }) => {
  return (
    <div className="box flex gap-5">
      <div className="icon flex items-center justify-center text-primary lg:bg-primary/20 h-[3rem] w-[3rem] md:w-16 md:h-16 rounded-full md:rounded-lg">
        {icon}
      </div>
  ...
  return (
    <>
      <section className="bg-gray-50 py-12">
        <section className="my-container m-auto">
      ...
      <section className=" py-6 md:py-12">
        <section className=" my-container">
          ...
          <div className="grid lg:grid-cols-1 gap-5 mt-10">
            <div className="box md:h-96 overflow-hidden flex items-center gap-1">
